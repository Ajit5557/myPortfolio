  ...
  return (
    <section id="about" className='py-4 px-[7vw] lg:px-[20vw] font-sans mt-16 md:mt-24 lg:mt-32'> 
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
        ...
        {/* Resume Button */}
        <a href="https://drive.google.com/file/d/1IFMmhg-8mqckdH15BspGzRBU3Dwn9-Pu/view?usp=drive_link" target='_blank' rel='noopener noreferrer' className='inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform:hover-scale-105'
        style={{
