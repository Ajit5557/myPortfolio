...
const Experience = () => {
  return (
    <section id='experience' className='py-24 pb-24 px-[7vw] lg:px-[16vw] font-sens bg-skills-gradient'>

      {/* Section Title */}
      <div className='text-center mb-16'>
        <h2 className='text-4xl font-bold text-white'>EXPERIENCE</h2>
        <div className='w-32 h-1 bg-purple-500 mx-auto mt-4'></div>
        <p className='text-gray-400 mt-4 text-lg'>My work experience and the roles I have taken in various organizations</p>
      </div>
        ...
        <div className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)]
          ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"} sm:ml-44 sm:mr-44 ml-8 transform transition:transform duration-300 hover-scale:105`}>
            ...
            <div className='flex items-center space-x-6'>
              ...
              {/* Date */}
              <p className='mt-4 text-gray-400'>{experience.date}</p>
              </div>
            </div>
